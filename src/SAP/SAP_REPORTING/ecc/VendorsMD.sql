SELECT
  ...
  -- LFA1.PPA_RELEVANT AS VendorIsPpaRelevant_PPA_RELEVANT,
  LFA1.PSOFG AS ProcessorGroup_PSOFG, LFA1.PSOIS AS SubledgerAcctPreprocessingProcedure_PSOIS, LFA1.PSON1 AS Name1_PSON1, LFA1.PSON2 AS Name2_PSON2,
